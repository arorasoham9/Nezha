...
const(
	...
	QUEUE_SHUTDOWN_UNSUCCESSFUL = 64564
	QUEUE_SHUTDOWN_SUCCESSFUL = 6436646436326732
	QUEUE_RESTART_SUCCESSFUL = 545562
	QUEUE_RESTART_UNSUCCESSFUL = 583283838
	TTL = 1000000000
	CONTAINER_IMAGE = "redis/redis-stack"
	CONTAINER_PORT = "6379"
	CONTAINER_MAPPED_PORT ="6379"
	SLEEP_TIME = 10
)
